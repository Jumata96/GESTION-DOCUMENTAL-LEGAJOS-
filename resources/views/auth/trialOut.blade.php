...
<head>
  ...
  <title>Página de Ingreso | InnovaMk</title>
        ...
        <div class="alert alert-danger">            
            <ul> 
                <blockquote style="margin: 0px">
                  <h6>Su licencia a cadudado.</h6>
                  <h6>Comuniquese con su proveedor del sistema.</h6>
                </blockquote>            
            </ul>
        </div>
  ...
  {{-- @if (count($errors) > 0)
        <div class="alert alert-danger">            
            <ul>
              ...
              @else
                <blockquote style="margin: 0px">Las credenciales ingresadas son incorrectas</blockquote>
              @endif              
            </ul>
        </div>
    @endif --}}
    ...
    <div class="card-panel" id="pagina-login" style="width: 25rem; padding: 0">
      ...
      <!--      <h6><i>Por su seguridad no revele su usuario y contraseña a terceros</i></h6>   -->
        ...
        <div class="row">
          <div class="input-field col s12">
            <a type="submit" class="btn waves-effect waves-light col s12  blue darken-4" style="height: 44px; letter-spacing: .5px;">Iniciar sessión
        ...
        {{-- <div class="row">
          <div class="input-field col s5 m5 l5">
            <p class="margin medium-small"><a >Registrate Ahora!</a></p>
          </div>                
        </div> --}}
