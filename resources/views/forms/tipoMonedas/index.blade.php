...
@section('titulo','Registrar Tipo de Moneda')
...
<div class="row" v-if="(seccion == 1)"> 
  <div class="col s12 m12 l12">
    <div class="card">
      ...
      <div class="row card-header sub-header">
              ...
              <button class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" v-on:click.prevent="viewCreate" data-position="top" data-delay="500" data-tooltip="Crear Nuevo Moneda">
 ...
 <div class="row cuerpo">                               
    ...
    <div class="card-content">
      <table class="responsive-table striped display bordered centered " cellspacing="0">
         <thead>
          <tr>
             <th>#</th>
       ...
       <tbody>
         <tr v-for="moneda in tipo_monedas">
           <td v-text="moneda.idmoneda"></td>
...
<div class="row" v-if="(seccion == 2)">
  <div class="col s12 m12 l12">
                 <div class="card">
                  <div class="card-header">                    
                    <i class="fa fa-table fa-lg material-icons">receipt</i>
                    <h2>CREAR NUEVO TIPO DE MONEDA</h2>
                  </div>              
                  <div class="row card-header sub-header">
                        <div class="col s12 m12">                         
                        <button class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" v-on:click.prevent="createMoneda" data-position="top" data-delay="500" title="Guardar" v-if="(enviando == 1)">
                        <i class="material-icons blue-text text-darken-2">check</i></button>
                        <button class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" v-on:click.prevent="createMoneda" data-position="top" data-delay="500" title="Guardar" disabled v-else>
                        <i class="material-icons blue-text text-darken-2">check</i></button>
  ...
  <div class="row">
      <div class="col s12 m12 l12">          
                    ...
                    <div class="card white">
                        <div class="card-content">
                          <span class="card-title">Datos del Moneda</span>
                          <div class="row">                     
...
<div class="row" v-if="(seccion == 3)">
  <div class="col s12 m12 l12">
                 <div class="card">
                  ...
                  <div class="row card-header sub-header">
                        <div class="col s12 m12">                         
                        <button class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" v-on:click.prevent="UpdateMoneda(fillMoneda.id)" data-position="top" data-delay="500" title="Actualizar" v-if="(enviando == 1)">
                        <i class="material-icons blue-text text-darken-2">check</i></button>
                    ...
                    <div class="card white">
                        <div class="card-content">
                          ...
                          <div class="row">                     
                            <div class="input-field col s12 m6 l6">
                              <i class="material-icons prefix">label_outline</i>
                              <input id="e_descripcion" name="e_descripcion" type="text" minlength="1" maxlength="10" v-model="fillMoneda.descripcion">
                              <label for="e_descripcion" class="active">Descripción</label>
                              <div style="color: red; font-size: 12px; font-style: italic;" v-text="errors.descripcion"></div>                                
                            </div>      
                            <div class="input-field col s12 m6 l6">
                              <i class="material-icons prefix">label</i>
                              <input id="e_dsc_corta" name="e_dsc_corta" type="text" maxlength="20" v-model="fillMoneda.dsc_corta">
...
<script type="text/javascript">
    var app5 = new Vue({      
      ...
      data: {
        ...
        enviando: '1',
        tipo_monedas: [], 
        fillMoneda: {'id': '', 'descripcion': '', 'dsc_corta': ''},
        b_descripcion: '',
        offset: 2,
        pagination: {
            total: 0,
      ...
      methods: {
        buscar: function(b_descripcion){
          ...
          var urlBuscar = 'moneda/buscar/' + b_descripcion;
          axios.get(urlBuscar).then(response => {
              this.tipo_monedas = response.data.tipo_monedas.data;
        ...
        changePage: function(page){
          ...
          this.urlTipoMonedas(page);
        },
        listTipoMonedas: function(page){
            var urlTipoMonedas= 'moneda/lista?page='+page;
            axios.get(urlTipoMonedas).then(response => {
                this.tipo_monedas = response.data.tipo_monedas.data;
                this.pagination = response.data.pagination;            
            });
        },
        ...
        edit: function(moneda){
          this.seccion = 3;
          this.fillMoneda.id = moneda.idmoneda;
          this.fillMoneda.descripcion = moneda.descripcion;
          this.fillMoneda.dsc_corta = moneda.dsc_corta;                 
        },
        deleteMoneda: function(moneda){
            var url = 'moneda/delete/' + moneda.idmoneda;
            axios.delete(url).then(response => {             
                setTimeout(function() {
                  Materialize.toast('<span>Tipo de Moneda Eliminada</span>', 1500);
                }, 100);
                this.listTipoMonedas();
            }).catch(error => {                      
                setTimeout(function() {
        ...
        disableMoneda: function(moneda){
            var url = 'moneda/disable/' + moneda.idmoneda;
            axios.delete(url).then(response => {             
                setTimeout(function() {
                  Materialize.toast('<span>Tipo de Moneda Dehabilitada</span>', 1500);
                }, 100);
                this.listTipoMonedas();
            }).catch(error => {                      
                setTimeout(function() {
        ...
        enableMoneda: function(moneda){
            var url = 'moneda/enable/' + moneda.idmoneda;
            axios.delete(url).then(response => {             
                setTimeout(function() {
                  Materialize.toast('<span>Moneda Habilitado</span>', 1500);
                }, 100);
                this.listTipoMonedas();
            }).catch(error => {                      
                setTimeout(function() {
        ...
        UpdateMoneda: function(id){
            var url = 'moneda/update/' + id;
            axios.put(url, {  
                descripcion: this.fillMoneda.descripcion,
                dsc_corta: this.fillMoneda.dsc_corta,                     
            }).then(response => {             
                setTimeout(function() {
                  Materialize.toast('<span>Moneda Actualizado</span>', 1500);
                }, 100);
                fillMoneda= {'id': '', 'descripcion': '', 'dsc_corta': ''};
                this.errors = '';
                this.listTipoMonedas();
        ...
        createMoneda: function() { 
            this.enviando = 0;           
            var url = 'moneda/store';
            axios.post(url, {  
                descripcion: this.descripcion,
                dsc_corta: this.dsc_corta,                                                  
            }).then(response => {             
                setTimeout(function() {
                  Materialize.toast('<span>Moneda Registrado</span>', 1500);
                }, 100);
                this.descripcion= '';
                this.dsc_corta= '';                           
                this.errors = '';
