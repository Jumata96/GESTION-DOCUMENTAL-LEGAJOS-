					...
					<div class="col s12 m6 l12">
						<div class="col s12">
							<ul class="tabs tab-demo z-depth-1">
								<li class="tab col s4" style="background-color: #78909c;"><a class="white-text waves-effect waves-light " href="#pestana1">FORMACIÓN ACADEMICA</a>
								</li>
								...
								{{-- 
								<li class="tab col s3" style="background-color: #78909c;"><a href="#pestana2" class="white-text waves-effect waves-light">CAPACITACIONES</a>
								</li>
								<li class="tab col s3" style="background-color: #78909c;"><a href="#pestana3" class="white-text waves-effect waves-light">PRODUCCIÓN INTELECTUAL </a>
								</li>
								<li class="tab col s3" style="background-color: #78909c;"><a href="#pestana4" class="white-text waves-effect waves-light">IDIOMAS</a>
								</li>
								--}}
							</ul>
						</div>
						<div class="col s12 ">
							<div id="pestana1" class="col s12 tabs-mk">        
								@include('forms.situacionAcademica.academicaTitulos')                
							</div>
							<div id="pestana2" class="col s12 tabs-mk">  
								@include('forms.situacionAcademica.digitalizarDocumento')                
							</div>
							{{-- 
							<div id="pestana3" class="col s12 tabs-mk" > 
								@include('forms.situacionAcademica.produccionIntelectual')                
							</div>
							<div id="pestana4" class="col s12 tabs-mk"> 
								@include('forms.situacionAcademica.idiomas')                
							</div>
							--}}
						</div>
					</div>
...
@include('forms.situacionAcademica.scripts.alertaConfirmacionEliminar')
@include('forms.situacionAcademica.scripts.alertaConfirmacionEliminarDj')
@endsection
@section('script')
@include('forms.situacionAcademica.scripts.scriptVueJs')                
@endsection