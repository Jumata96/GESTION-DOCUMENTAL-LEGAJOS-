          ...
          {{-- datos del servidor --}} 
                   ...
                   <div class="col s12">
                    <ul class="tabs tab-demo z-depth-1">
                      <li class="tab col s3" style="background-color: #78909c;"><a class="white-text waves-effect waves-light active" href="#pestana1">FORMACIÓN ACADEMICA</a>
                      </li>
                  ...
                  <div class="col s12 ">
                    ...
                    <div id="pestana2" class="col s12 tabs-mk">  
                      @include('forms.situacionAcademica.capacitaciones')                
                    </div>
