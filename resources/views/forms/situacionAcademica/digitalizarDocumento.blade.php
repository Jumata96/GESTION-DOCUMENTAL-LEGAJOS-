					...
					<div class="col s12 m12 l12">
						<div class="col s12 m12 l12">
							...
							<select class="browser-default" id="tipoDocumentoDeclaracionJurada" name="tipoDocumentoDeclaracionJurada" required>
								...
								<option value="CERTIFICADOS DE ESTUDIOS SUPERIORES"  >CERTIFICADOS DE ESTUDIOS SUPERIORES</option>
								<option value="CERTIFICADOS DE ESTUDIOS TECNICOS"  >CERTIFICADOS DE ESTUDIOS TECNICOS</option>
								<option value="CERTIFICADOS DE ESTUDIOS PRIMARIOS"  >CERTIFICADOS DE ESTUDIOS PRIMARIOS</option>
								<option value="TITULO"  >TITULO</option>
								<option value="COLEGIATURA"  >COLEGIATURA</option>
								<option value="BACHILLER"  >BACHILLER</option>
								<option value="MAESTRIA"  >MAESTRIA</option>
								<option value="HABILIDAD PROFESIONAL"  >HABILIDAD PROFESIONAL</option>
