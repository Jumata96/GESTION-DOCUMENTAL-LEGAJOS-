...
{{-- modals --}}
@include('forms.areaLaboral.scripts.alertaConfirmacionEliminar')
@include('forms.areaLaboral.scripts.alertaConfirmacionDesactivar')
@include('forms.areaLaboral.scripts.alertaConfirmacionHabilitar')
@include('forms.areaLaboral.modalAgregar')
@include('forms.areaLaboral.modalActualizar')
{{-- modals --}}
...
@section('script')  
@include('forms.areaLaboral.scripts.vuejs')
