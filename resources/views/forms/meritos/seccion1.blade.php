                       ...
                       <div class="col s12 m12 l12" style="padding-bottom: 15px"> 
                        <div class="col s12 m12 l12">
                          ...
                          <select   class="browser-default" id="tipoResolucion" name="tipoResolucion" required>
                            ...
                            <option value="RESOLUCIONES Y DOCUMENTOS DE FELICITACIONES">RESOLUCIONES Y DOCUMENTOS DE FELICITACIONES</option>
                            <option value="RESOLUCIONES Y DOCUMENTOS DE AGRADECIMIENTOS">RESOLUCIONES Y DOCUMENTOS DE AGRADECIMIENTOS</option> 
