...
{{-- modals --}}
@include('forms.nivelRemunerativo.scripts.alertaConfirmacionEliminar')
@include('forms.nivelRemunerativo.scripts.alertaConfirmacionDesactivar')
@include('forms.nivelRemunerativo.scripts.alertaConfirmacionHabilitar')
@include('forms.nivelRemunerativo.modalAgregar')
@include('forms.nivelRemunerativo.modalActualizar')
{{-- modals --}}
...
@section('script')  
@include('forms.nivelRemunerativo.scripts.vuejs')
