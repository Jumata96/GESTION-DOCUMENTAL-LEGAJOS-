	...
	<div class="col s12 m12 l12">
		<div class="card">
			<div class="card-header  ">
				...
				<h2>ASIGNACIONES E INCENTIVOS</h2>
			</div>
          ...
          {{-- datos del servidor --}} 
                   ...
                   <div class="col s12">
                    <ul class="tabs tab-demo z-depth-1">
                      <li class="tab col s3" style="background-color: #78909c;"><a class="white-text waves-effect waves-light active" href="#pestana1">DATOS DEL BENEFICIOS</a>
                      </li>
                      <li class="tab col s3" style="background-color: #78909c;"><a href="#pestana2" class="white-text waves-effect waves-light">SUBSIDIO POR LUTO SEPELIO</a>
                      </li>
                      <li class="tab col s3" style="background-color: #78909c;"><a href="#pestana3" class="white-text waves-effect waves-light">RETENCIONES JUDICIALES </a>
                      </li>
                      <li class="tab col s3" style="background-color: #78909c;"><a href="#pestana4" class="white-text waves-effect waves-light">DATOS DE MODIFICACIONES</a>
                      </li> 
                  ...
                  <div class="col s12 ">
                    <div id="pestana1" class="col s12 tabs-mk">        
                      @include('forms.incentivos.datosBeneficios')                
                    </div>
                    <div id="pestana2" class="col s12 tabs-mk">  
                      @include('forms.incentivos.datosSubsidio')                
                    </div>
                    <div id="pestana3" class="col s12 tabs-mk" > 
                      @include('forms.incentivos.datosRetenciones')                
                    </div>
                    <div id="pestana4" class="col s12 tabs-mk"> 
                      @include('forms.incentivos.datosModificaciones')                
