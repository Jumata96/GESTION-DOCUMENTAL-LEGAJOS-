					...
					<div class="col s12 m6 l12">
						<div class="col s12">
							<ul class="tabs tab-demo z-depth-1" style="background-color: #78909c;">
								<li class="tab col s4" style="background-color: #6f8a97;" ><a class="white-text waves-effect waves-light active" href="#pestana1">SANCIONES JUDICIALES</a>
								</li>
								<li class="tab col s4" style="background-color: #6f8a97;" ><a class="white-text waves-effect waves-light active" href="#pestana2">SANCIONES ADMINISTRATIVAS</a>
								</li>
								<li class="tab col s4" style="background-color: #6f8a97;" ><a class="white-text waves-effect waves-light active" href="#pestana3">RECURSOS ADMINISTRATIVOS</a>
								</li>
							</ul>
						</div>
						<div class="col s12 ">
							<div id="pestana1" class="col s12 tabs-mk">        
								@include('forms.sanciones.datosJudiciales')                
							</div>
							<div id="pestana2" class="col s12 tabs-mk">        
								@include('forms.sanciones.datosAdministrativos')                
							</div>
							<div id="pestana3" class="col s12 tabs-mk">        
								@include('forms.sanciones.datosRecursosAdministrativos')                
							</div>
						</div>
					</div>
				</div>
