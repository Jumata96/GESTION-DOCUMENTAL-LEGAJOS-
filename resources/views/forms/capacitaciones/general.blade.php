					...
					<div class="col s12 m6 l12">
						<div class="col s12">
							<ul class="tabs tab-demo z-depth-1">
								<li class="tab col s4" style="background-color: #78909c;"><a class="white-text waves-effect waves-light " href="#pestana1">capacitaciones</a>
								</li>
						...
						<div class="col s12 ">
							<div id="pestana1" class="col s12 tabs-mk">        
								@include('forms.capacitaciones.academicaTitulos')                
							</div>
							<div id="pestana2" class="col s12 tabs-mk">  
								@include('forms.capacitaciones.digitalizarDocumento')                
							</div> 
						</div>
					</div>
				</div>
...
@include('forms.capacitaciones.scripts.alertaConfirmacionEliminar')
@include('forms.capacitaciones.scripts.alertaConfirmacionEliminarDj')
@endsection
@section('script')
@include('forms.capacitaciones.scripts.scriptVueJs')                
@endsection