            ...
            <div class="card-content">
                       ...
                       <div class="col s12 m12 l6"> 
                        <div class="col s12 m12 l12">
                          ...
                          <select   class="browser-default" id="tipoResolucion" name="tipoResolucion" required>
                            ...
                            <option value="RESOLUCIONES BONIFICACIÓN FAMILIAR">RESOLUCIONES BONIFICACIÓN FAMILIAR</option>
                            <option value="RESOLUCIONES  DE AMPLIACIÓN DEL NUCLEO FAMILIAR">RESOLUCIONES  DE AMPLIACIÓN DEL NUCLEO FAMILIAR</option>
                            <option value="RESOLUCIONES DE DEVENGADOS POR PAGO DE BONIFICACIÓN FAMILIAR">RESOLUCIONES DE DEVENGADOS POR PAGO DE BONIFICACIÓN FAMILIAR</option>
                            <option value="RESOLUCIÓN DE BONIFICACIÓN POR GASTO DE SEPELIO Y SUBSIDIO POR LUTO">RESOLUCIÓN DE BONIFICACIÓN POR GASTO DE SEPELIO Y SUBSIDIO POR LUTO</option> 
               ...
               <div class="col s12 m12 l6">
                  ...
                  <div class="card">
                     ...
                     <div class="col s12 m6 l12" style="padding-bottom: 15px">
                        <label for="familiar">FAMILIAR REMUNERADO</label>                 
                        <select class="browser-default" id="familiar" name="familiar" required>
                          <option value="" disabled selected="">Seleccione</option>
                            <option  v-for="(familiar,index ) in familiares"     :value="familiar.codigo" v-text="familiar.nombres"> </option>
                        </select>
                        <div id="error_dir_familiar" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
                      </div>  
                       <div class="input-field col s12 m12 l12">
