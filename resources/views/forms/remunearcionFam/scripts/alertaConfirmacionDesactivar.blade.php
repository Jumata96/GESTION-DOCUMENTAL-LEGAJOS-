<div id="modalDesactivarCargoLaboral" class="modal" style="width: 500px">
	...
	<div class="modal-footer indigo lighten-4">
		...
		<a  v-on:click="desabilitarCargoLaboral()"  class="waves-effect waves-light btn-flat modal-action modal-close" >Aceptar</a>
	</div>
</div>