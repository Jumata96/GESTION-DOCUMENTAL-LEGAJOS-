					...
					<div class="col s12 m6 l12">
						<div class="col s12">
							<ul class="tabs tab-demo z-depth-1">
								<li class="tab col s4" style="background-color: #78909c;"><a class="white-text waves-effect waves-light " href="#pestana">familiares</a>
								</li>
								<li class="tab col s4" style="background-color: #78909c;"><a class="white-text waves-effect waves-light " href="#pestana1">remuneración</a>
								</li>
								<li class="tab col s4" style="background-color: #78909c;"><a href="#pestana2" class="white-text waves-effect waves-light">Documentos Digitalizados</a>
								</li> 
							</ul>
						</div>
						<div class="col s12 ">
							<div id="pestana" class="col s12 tabs-mk">        
								@include('forms.remunearcionFam.seccion0')                
							</div>
							<div id="pestana1" class="col s12 tabs-mk">        
								@include('forms.remunearcionFam.seccion1')                
							</div>
							<div id="pestana2" class="col s12 tabs-mk">  
								@include('forms.remunearcionFam.seccion2')                
							</div> 
						</div>
					</div>
				</div>
...
<br>
@include('forms.remunearcionFam.scripts.alertaConfirmacionEliminarSeccion01') 
@include('forms.remunearcionFam.scripts.alertaConfirmacionEliminarSeccion02') 
@include('forms.remunearcionFam.scripts.alertaConfirmacionEliminar')
@include('forms.remunearcionFam.scripts.alertaConfirmacionDesactivar')
@include('forms.remunearcionFam.scripts.alertaConfirmacionHabilitar')
@include('forms.remunearcionFam.modalActualizar')

</div> 
@endsection
@section('script')
@include('forms.remunearcionFam.scripts.scriptVueJs')                
@endsection