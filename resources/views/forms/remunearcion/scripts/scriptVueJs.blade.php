...
var app = new Vue({
   ...
   nombreServidor   : "",
	...
	listarDJ()
	{
		...
		var url = '/Remuneracion-Documentos';	
	...
	eliminarDocumentos()
	{
			...
			var url = '/Remuneracion-eliminarDocumento/' + codigoDJ; 
			axios.get(url).then((response) =>
			{   
						this.ListarRegistrosTablaSeccion01();
					this.listarDJ();
  ...
  document.getElementById("tbodyDj").innerHTML = "";
	...
	{ 
		...
		var url = '/Remuneracion/agregar' + '?' + $('#myFormModalSeccion01').serialize();
