					...
					<div class="col s12 m6 l12">
						<div class="col s12">
							<ul class="tabs tab-demo z-depth-1">
								<li class="tab col s4" style="background-color: #78909c;"><a class="white-text waves-effect waves-light " href="#pestana1">evaluaciones</a>
								</li>
						...
						<div class="col s12 ">
							<div id="pestana1" class="col s12 tabs-mk">        
								@include('forms.evaluaciones.seccion1')                
							</div>
							<div id="pestana2" class="col s12 tabs-mk">  
								@include('forms.evaluaciones.seccion2')                
							</div> 
						</div>
					</div>
				</div>
...
<br>
@include('forms.evaluaciones.scripts.alertaConfirmacionEliminarSeccion01') 
@include('forms.evaluaciones.scripts.alertaConfirmacionEliminarSeccion02') 
</div> 
@endsection
@section('script')
@include('forms.evaluaciones.scripts.scriptVueJs')                
@endsection