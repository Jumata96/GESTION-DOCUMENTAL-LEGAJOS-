	...
	<div class="col s12 m12 l12">
		<div class="card">
			<div class="card-header  ">
				...
				<h2>RENUNCIAS Y LIQUIDACIONES</h2>
			</div>
					...
					<div class="col s12 m6 l12">
						<div class="col s12">
							<ul class="tabs tab-demo z-depth-1">
								<li class="tab col s4" style="background-color: #78909c;"><a class="white-text waves-effect waves-light " href="#pestana1">renuncias</a>
								</li>
						...
						<div class="col s12 ">
							<div id="pestana1" class="col s12 tabs-mk">        
								@include('forms.renuncias.seccion1')                
							</div>
							<div id="pestana2" class="col s12 tabs-mk">  
								@include('forms.renuncias.seccion2')                
							</div> 
						</div>
					</div>
				</div>
...
<br>
@include('forms.renuncias.scripts.alertaConfirmacionEliminarSeccion01') 
@include('forms.renuncias.scripts.alertaConfirmacionEliminarSeccion02') 
</div> 
@endsection
@section('script')
@include('forms.renuncias.scripts.scriptVueJs')                
@endsection