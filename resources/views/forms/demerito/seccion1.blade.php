                       ...
                       <div class="col s12 m12 l12" style="padding-bottom: 15px"> 
                        <div class="col s12 m12 l12">
                          ...
                          <select   class="browser-default" id="tipoResolucion" name="tipoResolucion" required>
                            ...
                            <option value="RESOLUCIONES DE AMONESTACIONES">RESOLUCIONES DE AMONESTACIONES</option>
                            <option value="RESOLUCIONES DE SUSPENCIONES">RESOLUCIONES DE SUSPENCIONES</option>
                            <option value="RESOLUCIONES DE CESE TEMPORAL">RESOLUCIONES DE CESE TEMPORAL</option>
                            <option value="RESOLUCIONES DE PROCESOS ADMINISTRATIVOS Y RESPONSABILIDAD PECUNIARIA">RESOLUCIONES DE PROCESOS ADMINISTRATIVOS Y RESPONSABILIDAD PECUNIARIA</option>
                            <option value="RESOLUCIONES DE DESTITUCIÓN">RESOLUCIONES DE DESTITUCIÓN</option>  
                          </select>
