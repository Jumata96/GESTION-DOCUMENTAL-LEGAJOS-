...
var app = new Vue({
   ...
   nombreServidor   : "",
	...
	eliminarDocumentos()
	{
			...
			var url = '/Demerito-eliminarDocumento/' + codigoDJ; 
			axios.get(url).then((response) =>
			{   
						this.ListarRegistrosTablaSeccion01();
					this.listarDJ();
  ...
  document.getElementById("tbodyDj").innerHTML = "";
	...
	{ 
		...
		var url = '/Demerito/agregar' + '?' + $('#myFormModalSeccion01').serialize();
