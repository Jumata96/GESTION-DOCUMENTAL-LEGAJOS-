			...
			<div class="row"  v-show="datosEmpleador" >
												<div class="col s12 m6 l12" >
													...
													<div class="col s12 m6 l6">
														<label for="tipoRegistroViaje">TIPO </label>                 
														<select v-model="tipoRegistroViaje" class="browser-default" id="tipoRegistroViaje" name="tipoRegistroViaje" required>
													...
													<div class="col s12 m6 l6">
														<label for="paisRegistroViaje">PAIS</label>                 
														<select v-model="paisRegistroViaje" class="browser-default" id="paisRegistroViaje" name="paisRegistroViaje" required>
															<option value="" disabled selected="">Seleccione</option>
															{{-- <option value="Merito DIRECTORIAL"   selected="">RESOLUCION DIRECTORIAL</option> --}}
														</select>
														{{-- <div id="error1" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div> --}}
								...
								<div class="col s12 m6 l12" >
									...
									<div class="input-field col s12 m6 l6">
															...
															<input id="fechaInicioViajes" v-model="fechaInicioViajes" placeholder="" class="datepicker" name="fechaInicioViajes" type="text">
															<label for="fechaInicioViajes"> FECHA DE INICIO</label> 
															<div id="error3" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
										</div> 

										<div class="input-field col s12 m6 l6">
															<i class="material-icons prefix active">date_range</i>
															<input id="fechafinViajes" v-model="fechafinViajes" placeholder="" class="datepicker" name="fechafinViajes" type="text">
															<label for="fechafinViajes"> FECHA FIN</label> 
															<div id="error3" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
										</div> 
							</div>
