...
<div class="col s12 m6 l12">
   ...
   <div class="card">
      <div class="card-header  ">
         ...
         <h2>CONTRATOS Y NOMBRAMIENTOS</h2>
      </div>
      <div class="card-header" style="height: 50px; padding-top: 5px; background-color: #f6f6f6">
         <div class="col s12 m12">
            <a  href="#modalAddContrato" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped modal-trigger"  data-position="top" data-delay="500" data-tooltip="Agregar Grado de Estudio">
...
{{-- Datos de familiares  --}} 
{{-- modal --}}
<div id="modalAddContrato" class="modal modal-fixed-footer">
   <div class="modal-content" style="padding: 0px; overflow-y: disabled; height: 300%; background-color: #f9f9f9">
      <div class="card" style="position: fixed; width: 100%; z-index: 2">
         <div class="card-header">
            <i class="fa fa-table fa-lg material-icons">receipt</i>
            <h2>AGREGAR RESOLUCIÓN</h2>
         </div>
      </div>
      <div class="row card-header sub-header" style="margin-top: 48px; margin-left: 0rem; margin-right: 0rem; position: fixed; width: 100%; z-index: 3"> 
         <a id="addConceptoM" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" data-position="top" data-delay="500" data-tooltip="Guardar" v-on:click="agregarResolucion()" >
                       ...
                       <div class="col s12 m12 l12"> 
                        <div class="col s12 m12 l12">
                          ...
                          <select   class="browser-default" id="tipoResolucion" name="tipoResolucion" required>
                            ...
                            <option value="RESOLUCION DE CONTRATO">RESOLUCION DE CONTRATO</option>
                            <option value="RESOLUCION DE RENOVACIÓN">RESOLUCION DE RENOVACIÓN</option>
                            <option value="RESOLUCION DE NOMBRAMIENTO">RESOLUCION DE NOMBRAMIENTO</option>
