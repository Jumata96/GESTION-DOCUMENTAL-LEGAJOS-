	...
	<div class="col s12 m12 l12">
		<div class="card">
			<div class="card-header  ">
				...
				<h2>CONTATOS Y NOMBRAMIENTOS</h2>
			</div>
					...
					<div class="col s12 m6 l12">
						<div class="col s12">
							<ul class="tabs tab-demo z-depth-1">
								<li class="tab col s4" style="background-color: #78909c;"><a class="white-text waves-effect waves-light " href="#pestana1">DEZPLAZAMIENTO</a>
								</li>
						...
						<div class="col s12 ">
							<div id="pestana1" class="col s12 tabs-mk">        
								@include('forms.Contratos.contratos')                
							</div>
							<div id="pestana2" class="col s12 tabs-mk">  
								@include('forms.Contratos.digitalizarDocumento')                
							</div> 
						</div>
					</div>
				</div>
...
@include('forms.Contratos.scripts.alertaConfirmacionEliminar')
@include('forms.Contratos.scripts.alertaConfirmacionEliminarDj')
@endsection
@section('script')
@include('forms.Contratos.scripts.scriptVueJs')                
@endsection