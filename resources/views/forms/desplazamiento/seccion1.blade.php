...
<div class="col s12 m6 l12">
  ...
  <div class="card">
    <div class="card-header  ">
      ...
      <h2>AGREGAR DEZPLAZAMIENTO Y/O CARGOS DESEMPEÑADOS</h2>
    </div>
                       ...
                       <div class="col s12 m12 l12"> 
                        <div class="col s12 m12 l12">
                          ...
                          <select   class="browser-default" id="tipoResolucion" name="tipoResolucion" required>
                            ...
                            <option value="CONSTANCIA DE TRABAJO ANTERIOR M.S">CONSTANCIA DE TRABAJO ANTERIOR M.S</option>
                            <option value="RESOLUCIONES SOBRE ASIGNACIONES DE FUNCIONES">RESOLUCIONES SOBRE ASIGNACIONES DE FUNCIONES</option>
                            <option value="RESOLUCIONES DE DESIGNACIONES">RESOLUCIONES DE DESIGNACIONES</option>
                            <option value="RESOLUCIONES DE ENCARGATURAS DE FUNCIONES">RESOLUCIONES DE ENCARGATURAS DE FUNCIONES</option>
                            <option value="RESOLUCIONES DE PERMUTA">RESOLUCIONES DE PERMUTA</option>
                            <option value="RESOLUCIONES DE REASIGNACIONES">RESOLUCIONES DE REASIGNACIONES</option>
                            <option value="RESOLUCIONES DE ROTACIONES">RESOLUCIONES DE ROTACIONES</option>
                            <option value="RESOLUCIONES DE COMISION DE SERVICIOS">RESOLUCIONES DE COMISION DE SERVICIOS</option>
                            <option value="RESOLUCIONES DE TRANSFERENCIAS">RESOLUCIONES DE TRANSFERENCIAS</option>
                            <option value="RESOLUCIONES DE DEZPLAZAMIENTO DE PERSONAL">RESOLUCIONES DE DEZPLAZAMIENTO DE PERSONAL</option>
