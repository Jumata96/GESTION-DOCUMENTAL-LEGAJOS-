...
var app = new Vue({
   ...
   nombreServidor   : "",
	...
	listarDJ()
	{
		...
		var url = '/Desplazamiento-Documentos';	
	...
	{  
		...
		var url = '/Desplazamiento-doc/agregar' + '?' + $('#myFormDJ').serialize();
	...
	eliminarDocumentos()
	{
			...
			var url = '/Desplazamiento-eliminarDocumento/' + codigoDJ; 
			axios.get(url).then((response) =>
			{   
						this.ListarRegistrosTablaSeccion01();
					this.listarDJ();
  ...
  document.getElementById("tbodyDj").innerHTML = "";
	...
	{ 
		...
		var url = '/Desplazamiento/agregar' + '?' + $('#myFormModalSeccion01').serialize();
		axios.post(url, formData,
			{
				headers:
				{
	...
	eliminarRegistroSeccion01()
	{
		console.log('ingreso a eleinar');
			...
			var url = '/Desplazamiento/eliminar' ; 
