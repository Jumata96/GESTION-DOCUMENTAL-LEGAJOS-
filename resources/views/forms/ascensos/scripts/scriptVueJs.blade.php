...
var app = new Vue({
   ...
   nombreServidor   : "",
	...
	eliminarDocumentos()
	{
			...
			var url = '/Ascensos-eliminarDocumento/' + codigoDJ; 
			axios.get(url).then((response) =>
			{   
						this.ListarRegistrosTablaSeccion01();
					this.listarDJ();
  ...
  document.getElementById("tbodyDj").innerHTML = "";
	...
	{ 
		...
		var url = '/Ascensos/agregar' + '?' + $('#myFormModalSeccion01').serialize();
