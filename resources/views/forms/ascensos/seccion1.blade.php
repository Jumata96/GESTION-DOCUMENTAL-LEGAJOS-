                       ...
                       <div class="col s12 m12 l12"> 
                        <div class="col s12 m12 l12">
                          ...
                          <select   class="browser-default" id="tipoResolucion" name="tipoResolucion" required>
                            ...
                            <option value="RESOLUCIONES DE ASCENSOS">RESOLUCIONES DE ASCENSOS</option>
                            <option value="RESOLUCIONES DE RECATEGORIZACIÓN">RESOLUCIONES DE RECATEGORIZACIÓN</option>
                            <option value="RESOLUCIONES DE ADECUACIÓN">RESOLUCIONES DE ADECUACIÓN</option>
                            <option value="RESOLUCIONES DE PROMOCIÓN">RESOLUCIONES DE PROMOCIÓN</option>
