      ...
      <form id="myFormSituacionAcademicaUpd" accept-charset="UTF-8" enctype="multipart/form-data" >
        ...
        <div class="card-content card"> <br>
              <div class=" col s12 m12 l12">
                ...
                <input id="nombreCargoLaboralUpd" placeholder="" name="nombreCargoLaboralUpd" type="text" data-error=".errorTxt1"   onkeyup="mayus(this);">
                <label for="nombreCargoLaboralUpd">NOMBRE DEL ÁREA LABORAL</label>
                <div id="error_nombreCargoLaboralUpd" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
              </div>
              <div class="input-field col s12 m12 l6">
                <i class="material-icons prefix ">edit</i>
                <input id="detalleCargoLaboralUpd" placeholder="" name="detalleCargoLaboralUpd" type="text" data-error=".errorTxt1"   onkeyup="mayus(this);">
                <label for="detalleCargoLaboralUpd">ANOTACIONES</label> 
                <div id="error_detalleCargoLaboralUpd" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
