          ...
          {{-- datos del servidor --}} 
                   ...
                   <div class="col s12">
                    <ul class="tabs tab-demo z-depth-1" style="background-color: #78909c;">
                      <li class="tab col s3" style="background-color: #6f8a97;" ><a class="white-text waves-effect waves-light active" href="#pestana1">DATOS DE INGRESO</a>
                      </li>  
                  </ul>
                  </div>                  
                  <div class="col s12 ">
                    <div id="pestana1" class="col s12 tabs-mk">        
                      @include('forms.ingresoReingreso.datosIngreso')                
                    </div> 
                  </div>       
					</div>
				</div>
