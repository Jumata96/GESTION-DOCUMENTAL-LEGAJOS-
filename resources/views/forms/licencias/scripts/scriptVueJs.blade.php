...
var app = new Vue({
   ...
   nombreServidor   : "",
	...
	{  
		...
		var url = '/Licencias-doc/agregar' + '?' + $('#myFormDJ').serialize();
	...
	eliminarDocumentos()
	{
			...
			var url = '/Licencias-eliminarDocumento/' + codigoDJ; 
			axios.get(url).then((response) =>
			{   
						this.ListarRegistrosTablaSeccion01();
					this.listarDJ();
  ...
  document.getElementById("tbodyDj").innerHTML = "";
	...
	{ 
		...
		var url = '/Licencias/agregar' + '?' + $('#myFormModalSeccion01').serialize();
		axios.post(url, formData,
			{
				headers:
				{
