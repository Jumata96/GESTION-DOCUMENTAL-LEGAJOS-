					...
					<div class="col s12 m6 l12">
						...
						<div class="col s12 ">
							<div id="pestana1" class="col s12 tabs-mk">        
								@include('forms.licencias.seccion1')                
							</div>
							<div id="pestana2" class="col s12 tabs-mk">  
								@include('forms.licencias.seccion2')                
							</div> 
						</div>
					</div>
				</div>
...
<br>
@include('forms.licencias.scripts.alertaConfirmacionEliminarSeccion01') 
@include('forms.licencias.scripts.alertaConfirmacionEliminarSeccion02') 
</div> 
@endsection
@section('script')
@include('forms.licencias.scripts.scriptVueJs')                
@endsection