...
var app = new Vue({
   ...
   nombreServidor   : "",
	...
	listarDJ()
	{
		...
		var url = '/evaluaciones-Documentos';	
	...
	eliminarDocumentos()
	{
			...
			var url = '/evaluaciones-eliminarDocumento/' + codigoDJ; 
			axios.get(url).then((response) =>
			{   
						this.ListarRegistrosTablaSeccion01();
					this.listarDJ();
  ...
  document.getElementById("tbodyDj").innerHTML = "";
	...
	{ 
		...
		var url = '/evaluaciones/agregar' + '?' + $('#myFormModalSeccion01').serialize();
