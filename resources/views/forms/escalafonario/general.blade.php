	...
	<div class="col s12 m12 l12">
		<div class="card">
			<div class="card-header  ">
				...
				<h2>INFORME ESCALAFONARIO  </h2>
			</div>
			<div class="card-header" style="height: 50px; padding-top: 5px; background-color: #f6f6f6">
				<div class="col s12 m12">
					{{-- <a class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" v-on:click="GenerarReporte()" data-position="top" data-delay="500" data-tooltip="GENERAR REPORTE">
				...
				<div class="row" >
                   ...
                   <div class="col s12">
                    <ul class="tabs tab-demo z-depth-1" style="background-color: #78909c;">
                      <li class="tab col s6" style="background-color: #6f8a97;" ><a class="white-text waves-effect waves-light active" href="#pestana1">CREAR INFORME</a>
                      </li>  
																						<li class="tab col s6" style="background-color: #6f8a97;" ><a class="white-text waves-effect waves-light active" href="#pestana2">HISTORIAL DE INFORMES </a>
                      </li>  
                  </ul>
                  </div>                  
                  <div class="col s12 ">
                    <div id="pestana1" class="col s12 tabs-mk">        
                      @include('forms.escalafonario.datosCrearInforme')                
                    </div> 
																				<div id="pestana2" class="col s12 tabs-mk">        
                      @include('forms.escalafonario.datosHistorialHinforme')                
                    </div> 
                  </div>       
					</div>
				</div>
...
@endsection
@section('script')
@include('forms.escalafonario.scripts.scriptVueJs')                
@endsection