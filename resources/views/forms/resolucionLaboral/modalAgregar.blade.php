      ...
      <form id="myFormSituacionAcademica" accept-charset="UTF-8" enctype="multipart/form-data" >
        ...
        <div class="card-content card"> <br>
              <div class=" col s12 m12 l12">
                ...
                <input id="nombreResolucionLaboral" name="nombreResolucionLaboral" type="text" data-error=".errorTxt1"   onkeyup="mayus(this);">
                <label for="nombreResolucionLaboral">NOMBRE DE LA RESOLUCIÓN LABORAL</label>
                <div id="error_nombreResolucionLaboral" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
              </div>
              <div class="input-field col s12 m12 l6">
                <i class="material-icons prefix ">edit</i>
                <input id="detalleResolucionLaboral" name="detalleResolucionLaboral" type="text" data-error=".errorTxt1"   onkeyup="mayus(this);">
                <label for="detalleResolucionLaboral">ANOTACIONES</label> 
                <div id="error_detalleResolucionLaboral" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
