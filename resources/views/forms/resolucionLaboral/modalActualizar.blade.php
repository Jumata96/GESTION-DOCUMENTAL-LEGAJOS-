  ...
  <div class="modal-content" style="padding: 0px; overflow-y: disabled; height: 300%; background-color: #f9f9f9">
    <div class="card" style="position: fixed; width: 100%; z-index: 2">
      <div class="card-header">
        ...
        <h2>AGREGAR RESOLUCIÓN LABORAL</h2>
      </div>
    </div>
      ...
      <form id="myFormSituacionAcademicaUpd" accept-charset="UTF-8" enctype="multipart/form-data" >
        ...
        <div class="card-content card"> <br>
              <div class=" col s12 m12 l12">
                ...
                <input id="nombreResolucionLaboralUpd" placeholder="" name="nombreResolucionLaboralUpd" type="text" data-error=".errorTxt1"   onkeyup="mayus(this);">
                <label for="nombreResolucionLaboralUpd">NOMBRE DEL LA RESOLUCIÓN LABORAL</label>
                <div id="error_nombreResolucionLaboralUpd" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
              </div>
              <div class="input-field col s12 m12 l6">
                <i class="material-icons prefix ">edit</i>
                <input id="detalleResolucionLaboralUpd" placeholder="" name="detalleResolucionLaboralUpd" type="text" data-error=".errorTxt1"   onkeyup="mayus(this);">
                <label for="detalleResolucionLaboralUpd">ANOTACIONES</label> 
                <div id="error_detalleResolucionLaboralUpd" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
