                       ...
                       <div class="col s12 m12 l12"> 
                        <div class="col s12 m12 l12">
                          ...
                          <select   class="browser-default" id="tipoResolucion" name="tipoResolucion" required>
                            ...
                            <option value="RESOLUCIONES DE PROGRAMACIÓN DE VACACIONES">RESOLUCIONES DE PROGRAMACIÓN DE VACACIONES</option>
                            <option value="RESOLUCIONES DE POSTERGACIÓN DE VACACIONES">RESOLUCIONES DE POSTERGACIÓN DE VACACIONES</option>
                            <option value="RESOLUCIONES DE SUSPENCIÓN DE VACACIONES">RESOLUCIONES DE SUSPENCIÓN DE VACACIONES</option> 
                          </select>
