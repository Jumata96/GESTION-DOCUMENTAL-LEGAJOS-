...
var app = new Vue({
   ...
   nombreServidor   : "",
	...
	{  
		...
		var url = '/Vacaciones-doc/agregar' + '?' + $('#myFormDJ').serialize();
	...
	eliminarDocumentos()
	{
			...
			var url = '/Vacaciones-eliminarDocumento/' + codigoDJ; 
			axios.get(url).then((response) =>
			{   
						this.ListarRegistrosTablaSeccion01();
					this.listarDJ();
  ...
  document.getElementById("tbodyDj").innerHTML = "";
	...
	{ 
		...
		var url = '/Vacaciones/agregar' + '?' + $('#myFormModalSeccion01').serialize();
		axios.post(url, formData,
			{
				headers:
				{
