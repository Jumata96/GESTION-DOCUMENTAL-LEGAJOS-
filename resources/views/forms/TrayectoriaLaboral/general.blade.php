          ...
          {{-- datos del servidor --}} 
                   ...
                   <div class="col s12">
                    <ul class="tabs tab-demo z-depth-1" style="background-color: #78909c;">
                      <li class="tab col s4" style="background-color: #6f8a97;" ><a class="white-text waves-effect waves-light active" href="#pestana1">Situación laboral actual</a>
                      </li>  
																						<li class="tab col s4" style="background-color: #6f8a97;" ><a class="white-text waves-effect waves-light active" href="#pestana2">Datos de desplazamiento</a>
                      </li>  
																						<li class="tab col s4" style="background-color: #6f8a97;" ><a class="white-text waves-effect waves-light active" href="#pestana3">Ascenso de escala </a>
                      </li>  
                  </ul>
                  </div>                  
                  <div class="col s12 ">
