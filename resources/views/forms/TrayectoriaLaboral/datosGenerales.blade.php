			...
			<div class="col s12 m12 l12">
				<div class="col s12 m6 l12">
					<div class="input-field col s12 m6 l4">
						...
						<input readonly="readonly" placeholder="" id="ultimoMovimeintoActual" name="ultimoMovimeintoActual" type="text" data-error=".errorTxt1"   onkeyup="mayus(this);">
						<label for="ultimoMovimeintoActual">ÚLTIMO MOVIMIENTO</label> 
					</div>
				</div>
				{{-- <div class="col s12 m6 l12">
					<div class="input-field col s12 m6 l4">
						<i class="material-icons prefix active">chrome_reader_mode</i>
						<input readonly="readonly" placeholder="" id="estadoCivil" name="estadoCivil" type="text" data-error=".errorTxt1" onkeyup="mayus(this);">
						<label for="estadoCivil">Estado Civil</label>
						<div id="error4" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
					</div>
					<div class="input-field col s12 m6 l4">
						<i class="material-icons prefix active">chrome_reader_mode</i>
						<input readonly="readonly" placeholder="" id="sexo" name="sexo" type="text" data-error=".errorTxt1" onkeyup="mayus(this);">
				...
				<div class="col s12 m6 l12">
					<div class="input-field col s12 m6 l4">
						...
						<label for="codigoPlazaActual">CODIGO PLAZA</label> 
					</div>
					<div class="input-field col s12 m6 l4">
						...
						<label for="modalidadEducativaActual">MODALIDAD EDUCATIVA</label> 
					</div>
					<div class="input-field col s12 m6 l4">
						<i class="material-icons prefix active">school</i>
						...
						<label for="nivelEducativoActual">NIVEL EDUCATIVO</label> 
					</div>
				</div>
				<div class="col s12 m6 l12">
					<div class="input-field col s12 m6 l4">
				...
				<div class="col s12 m6 l12">
					<div class="input-field col s12 m6 l4">
						<i class="material-icons prefix active">next_week</i>
						<input readonly="readonly" placeholder="" id="cargoActual" name="cargoActual" type="text" data-error=".errorTxt1" onkeyup="mayus(this);">
						<label for="cargoActual">CARGO</label>
						<div id="error4" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
					</div>
					<div class="input-field col s12 m6 l4">
						<i class="material-icons prefix active">event_note</i>
						<input readonly="readonly" placeholder="" id="jormanaActual" name="jormanaActual" type="text" data-error=".errorTxt1" onkeyup="mayus(this);">
						<label for="jormanaActual">JORNADA</label>
						<div id="error5" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
					</div>
				</div>
			</div> 
