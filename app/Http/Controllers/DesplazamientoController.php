...
class DesplazamientoController extends Controller
{
    ...
    public function Index(){
        ...
        return view('forms.desplazamiento.general',[
    ...
    public function  DatosList(){
        //  dd('llego');
          ...
          $trabajador_id = session('trabajador_Id');//obtenber los datos del trabajador a consultar
            ...
            $desplazamiento = DB::table('desplazamiento')->where('id_trabajador',intval($trabajador_id))->where('estado',1)->get(); 
    ...
    public function eliminarDatos(Request $request){ 
        // dd($request);
       $codigo= DB::table('desplazamiento')->select('id_doc')->where('codigo',$request->id)->get();
    //    dd($codigo[0]->id_doc);
