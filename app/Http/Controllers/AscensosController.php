...
class AscensosController extends Controller
{
    ...
    public function Index(){
        ...
        return view('forms.ascensos.general',[
            ...
            // dd($distrito[0]->distrito); 
                 $trabajador_id = session('trabajador_Id'); 
                    ...
                    ->insert([
                        ...
                        'cargo_laboral_anterior'=>$trabajador[0]->cargo,  
    ...
    public function  DatosList(){
        //  dd('llego');
          ...
          $trabajador_id = session('trabajador_Id');//obtenber los datos del trabajador a consultar
            ...
            $desplazamiento = DB::table('ascensos')->where('id_trabajador',intval($trabajador_id))->where('estado',1)->get(); 
    ...
    public function eliminarDatos(Request $request){ 
        // dd($request);
       $codigo= DB::table('ascensos')->select('id_doc')->where('codigo',$request->id)->get();
        //    dd($codigo[0]->id_doc);
